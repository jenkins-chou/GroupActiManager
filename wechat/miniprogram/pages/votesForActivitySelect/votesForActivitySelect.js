// miniprogram/pages/votesForActivitySelect/votesForActivitySelect.js
var app = getApp()
Page({
  ...
  onLoad: function (options) {
    ...
    try {
      ...
      wx.request({
        url: app.globalBaseUrl + '/vote/getAllByCreator',
  ...
  submit:function(){
    ...
    var that = this;
    wx.request({
      url: app.globalBaseUrl + '/activity/addVotesForActivity',
      data: { 
